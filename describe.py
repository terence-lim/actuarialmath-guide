...
_methods = {
    Actuarial: ['solve', 'add_term', 'max_term'],
    ...
    Insurance: ['E_x', 'A_x', 'insurance_variance', 'whole_life_insurance', 
                ...
                'increasing_insurance', 'decreasing_insurance', 'Z_t',
                'Z_from_t', 'Z_to_t', 'Z_from_prob','Z_to_prob', 'Z_x', 'Z_plot'],
    Annuity: ['a_x', 'immediate_annuity', 'annuity_twin', 'insurance_twin',
              ...
              'decreasing_annuity', 'Y_t', 'Y_from_t', 'Y_from_prob',
              'Y_to_prob', 'Y_x', 'Y_plot'],
    ...
    PolicyValues: ['net_future_loss', 'net_variance_loss', 'net_policy_variance', 
                   'gross_future_loss', 'gross_policy_variance',
                   'gross_policy_value', 'L_from_t', 'L_to_t', 'L_from_prob',
                   'L_to_prob', 'L_plot'],
    Reserves: ['set_reserves', 'fill_reserves', 't_V_forward', 
               't_V_backward', 't_V', 'r_V_forward', 'r_V_backward',
               'FPT_premium', 'FPT_policy_value', 'V_plot', 'V_t'],    
